...
namespace Vistian.Reactive.Proxy.Utils
{
    public class DebuggerDisplayFormatter
    {
        ...
        {
            var debuggerDisplayAttributes = type.GetTypeInfo().GetCustomAttributes(typeof(DebuggerDisplayAttribute), false).ToArray();
        ...
        static Func<object, string> CreatePropertyValueDelegate(Type type, string propertyName, bool quote)
        {
            ...
            var fieldInfo = type.GetRuntimeField(propertyName);
