...
{
    public class OperatorObservable<T> : IObservable<T>, IOperatorObservable
    {
        ...
        public OperatorObservable(ISession session, IObservable<T> inner, OperatorInfo operatorInfo)
        {
            if (inner == null)
